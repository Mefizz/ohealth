<?php use \App\Enums\Person\AuthenticationMethod; ?>
        ...
        >
                    ...
                    <div>
                        <div class="mb-8 flex items-center justify-between">
                            <legend class="legend !mb-0 text-2xl font-bold text-gray-900 dark:text-white">
                                <?php echo e(__('patients.authentication_methods')); ?>
            ...
            ?>
                                    <p class="font-semibold text-red-700 dark:text-red-300">
                                        <?php echo e(__('forms.patient_has_no_auth_methods')); ?>
                                    ...
                                    <div class="fieldset mb-4 space-y-3 rounded-2xl border border-gray-200 bg-white p-5 shadow-none dark:border-gray-700 dark:bg-gray-800">
                                        <div class="flex items-start justify-between gap-4">
                                            <div
                                                class="shrink"
                                                x-data="{
                                                    labels: <?php echo \Illuminate\Support\Js::from(AuthenticationMethod::options())->toHtml() ?>,
                                                    prefix: '<?php echo e(__('forms.authentication')); ?>'
                                                }"
                                            >
                                                <h3
                                            ...
                                            <div class="flex items-center gap-4">
                                                <div x-data="{ open: false }" class="relative">
                                                    ...
                                                    >
                                                        <template x-if="method.type === '<?php echo e(AuthenticationMethod::OTP->value); ?>'">
                                                            <button
                                                                type="button"
                                                                @click="open = false"
                                                            ...
                                                            >
                                                                <?php echo e(__('patients.change_phone_number')); ?>

                                                            </button>
                                                        </template>

                                                        <template x-if="method.type === '<?php echo e(AuthenticationMethod::OFFLINE->value); ?>'">
                                                            <button
                                                                type="button"
                                                                @click="open = false"
                                                                class="w-full cursor-pointer rounded px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                                            >
                                                                <?php echo e(__('patients.change_method_to_sms')); ?>
                                                        ...
                                                        <button
                                                            ...
                                                            class="w-full cursor-pointer rounded px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                                        >
                                                            <?php echo e(__('patients.change_method_alias')); ?>

                                                        </button>

                                                        <template x-if="method.type === '<?php echo e(AuthenticationMethod::THIRD_PERSON->value); ?>'">
                                                            <button
                                                                type="button"
                                                                @click="open = false"
                                                                class="w-full cursor-pointer rounded px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                                            >
                                                                <?php echo e(__('patients.deactivate_method')); ?>
                                        ...
                                        <template x-if="method.type !== '<?php echo e(AuthenticationMethod::THIRD_PERSON->value); ?>'">
                                            <div>
                                                <p class="text-sm text-gray-600 dark:text-gray-300">
                                                    <?php echo e(__('patients.authentication_method_name')); ?>:
                                                    <span
                                        ...
                                        <div class="space-y-2">
                                            <template x-if="method.type === '<?php echo e(AuthenticationMethod::OTP->value); ?>'">
                                                <div class="space-y-1.5 pt-1">
                                                    <label class="label-modal !mb-1 text-xs font-medium text-gray-500 dark:text-gray-400">
                                                        <?php echo e(__('forms.phone_number')); ?>
                                            ...
                                            <template x-if="method.type === '<?php echo e(AuthenticationMethod::OFFLINE->value); ?>'">
                                                <div class="pt-1 text-sm text-gray-500 dark:text-gray-400">
                                                    <?php echo e(__('patients.offline_auth_method_description')); ?>
                                            ...
                                            <template x-if="method.type === '<?php echo e(AuthenticationMethod::THIRD_PERSON->value); ?>'">
                                                <div class="space-y-4 pt-1">
                                                    <div class="form-row-2">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="label-modal !mb-1 text-xs font-medium text-gray-500 dark:text-gray-400">
                                                                <?php echo e(__('patients.ended_at')); ?>
                                                    ...
                                                    <template x-if="method.confidantPerson || method.confidant_person">
                                                        <div class="form-row-2">
                                                            <div class="form-group">
                                                                <label class="label-modal !mb-1 text-xs font-medium text-gray-500 dark:text-gray-400">
                                                                    <?php echo e(__('patients.confidant_full_name')); ?>
...
<?php /**PATH /var/www/html/.worktrees/i489_refactor/resources/views/livewire/care-plan/modals/method-selection.blade.php ENDPATH**/ ?>