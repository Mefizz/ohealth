                ...
                >
                    <div>
                        <legend class="legend mb-6 text-2xl font-bold text-gray-900 dark:text-white">
                            <?php echo e(__('care-plan.auth_modal_title')); ?>

                        </legend>

                        <div class="mb-6">
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                <?php echo e(__('care-plan.sms_sent_to_number')); ?>

                                <strong class="ml-1 text-gray-900 dark:text-white"><?php echo e($phoneNumber ?? '-'); ?></strong>
                            </p>
                        </div>

                        <div class="pt-2">
                            <h3 class="mb-6 text-xl font-bold text-gray-900 dark:text-white">
                                <?php echo e(__('patients.code_sms')); ?>
                            ...
                            <div class="flex items-end gap-4" style="display: flex; align-items: flex-end">
                                ...
                                >
                                    <input
                                        type="text"
                                        placeholder=" "
                                        class="peer input <?php $__errorArgs = ['verificationCode'];
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <label class="label" for="verificationCode">
                                        <?php echo e(__('forms.confirmation_code_from_SMS')); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                $iconArgs = ['mail', 'w-4 h-4 text-gray-600 dark:text-gray-300'];
            ...
            ?>
                                        <span>
                                            <span x-show="timer > 0"
                                                ><?php echo e(__('patients.resend_again_in_seconds')); ?>

                                                <span x-text="timer"></span> <?php echo e(__('patients.seconds_short')); ?></span>
                                            <span x-show="timer === 0"><?php echo e(__('forms.send_again')); ?></span>
                                        </span>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="mt-12 flex items-center justify-end gap-4">
                            <button type="button" @click="showAuthModal = false" class="button-minor px-6 py-2.5">
                                <?php echo e(__('forms.cancel') ?? 'Скасувати'); ?>
...
<?php /**PATH /var/www/html/.worktrees/i489_refactor/resources/views/livewire/care-plan/modals/authentication.blade.php ENDPATH**/ ?>