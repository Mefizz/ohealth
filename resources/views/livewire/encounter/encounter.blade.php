@php
    ...
    $mainGroups = [
        ...
        ['id' => 'device-dispense', 'label' => __('device-dispenses.label'), 'icon' => 'solid-notes-medical', 'view' => 'livewire.encounter.parts.device-dispense', 'holdsCancellableRecords' => true],
        ['id' => 'specimens', 'label' => __('specimens.label'), 'icon' => 'sample-outline', 'view' => 'livewire.encounter.parts.specimens', 'holdsCancellableRecords' => true],
    ];
