...
>
    <h3 class="modal-header">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($activityForm['id']) && $activityForm['id']): ?>
            <?php echo e(__('care-plan.edit_medication_prescription')); ?>
    ...
    <form wire:submit.prevent="saveActivity">
        ...
        <fieldset class="fieldset">
            ...
            <div class="mb-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="form-group group">
                    <label class="label" for="medication_program_edit"> <?php echo e(__('care-plan.program')); ?> </label>
                    ...
                    <?php else: ?>
                        <input
                            ...
                            value="<?php echo e(!empty($activityForm['program']) ? ($dictionaries['medical_programs'][$activityForm['program']] ?? $activityForm['program']) : __('care-plan.prescription_medication')); ?>"
                            disabled
                        />
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <div class="form-group group">
                    <label class="label"> <?php echo e(__('care-plan.medication')); ?>* </label>
                    <div class="relative">
                        <input
                            type="text"
                            ...
                            value="<?php echo e(!empty($selectedProduct) ? ($selectedProduct['name'] ?? '') : ''); ?>"
                            disabled
                        />
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($activityForm['id'])): ?>
                            <button
            ...
            <div class="mb-4 grid grid-cols-1 gap-6 md:grid-cols-3">
                <div class="form-group group">
                    <label for="med_quantity" class="label"> <?php echo e(__('care-plan.quantity')); ?> </label>
                    <div class="flex gap-2">
                        ...
                        <select class="input-select peer w-20" wire:model="activityForm.quantity_system">
                            <option value="MEDICATION_UNIT">
                                <?php echo e(match($activityForm['quantity_code'] ?? '') { 'PIECE' => 'шт.', 'ML' => 'мл', 'MG' => 'мг', 'G' => 'г', '' => __('care-plan.ml'), default => $activityForm['quantity_code'] }); ?>
            ...
            <div class="mb-4 grid grid-cols-1 gap-6 md:grid-cols-3">
                <div class="form-group group">
                    <label for="med_quantity_per_time" class="label"> <?php echo e(__('care-plan.quantity_per_time')); ?> </label>
                    <div class="flex gap-2">
                        <input
                            type="number"
                        ...
                        <select class="input-select peer w-20" disabled>
                            <option selected value="<?php echo e($activityForm['daily_amount_code'] ?? 'PIECE'); ?>">
                                <?php echo e(match($activityForm['daily_amount_code'] ?? 'PIECE') { 'PIECE' => 'шт.', 'ML' => 'мл', 'MG' => 'мг', 'G' => 'г', default => $activityForm['daily_amount_code'] ?? 'шт.' }); ?>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div class="form-group group">
                    <label for="med_number_of_times" class="label"> <?php echo e(__('care-plan.number_of_times')); ?> </label>
                    <div class="flex gap-2">
                        <input
                            type="number"
                ...
                <div class="form-group group">
                    <label for="med_duration" class="label"> <?php echo e(__('care-plan.duration')); ?> </label>
        ...
        <fieldset class="fieldset">
            ...
            <div class="form-row-3">
                <div class="form-group group">
                    <label for="med_expected_result" class="label"> <?php echo e(__('care-plan.expected_result')); ?> </label>
                    <select id="med_expected_result" name="med_expected_result" class="input-select peer w-full">
                        <option selected value=""><?php echo e(__('care-plan.select_service')); ?></option>
                    </select>
                </div>
            </div>

            <div class="form-group group mt-4">
                <label for="med_description" class="label mb-2"> <?php echo e(__('care-plan.extended_description')); ?> </label>
                <textarea
                    id="med_description"
...
<?php /**PATH /var/www/html/.worktrees/i489_refactor/resources/views/livewire/care-plan/parts/modals/medication-form-drawer.blade.php ENDPATH**/ ?>