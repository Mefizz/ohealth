    ...
    <div class="form-row-2 mt-5">
        <div class="form-group group">
            <div class="datepicker-wrapper">
                <input wire:model.lazy="form.periodStart"
                       type="text"
                       name="period_start"
                       id="period_start"
            ...
            <p class="text-error text-xs mt-1" id="error-form-period-start">{{ $message }}</p>
            @enderror
        </div>

        <div class="form-group group">
            <div class="datepicker-wrapper">
                <input wire:model.lazy="form.periodEnd"
                       type="text"
                       name="period_end"
                       id="period_end"
            ...
            <p class="text-error text-xs mt-1" id="error-form-period-end">{{ $message }}</p>
            @enderror
        </div>
    </div>
