...
class CompositionLifecycleServiceTest extends TestCase
{
    ...
    public function test_create_returns_the_scheduled_job_and_writes_nothing_locally(): void
    {
        ...
        $job = $this->service()->create(['type' => ['coding' => [['system' => 'COMPOSITION_TYPES', 'code' => 'NEWBORN']]]]);
    ...
    /**
     * createComposition accepts the unsigned compositionRequest JSON; PKCS#7 under `data`
     * is reserved for sign/cancel.
     */
