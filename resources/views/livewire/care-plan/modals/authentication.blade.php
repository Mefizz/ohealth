<div x-data="{ 
    ...
    <template x-teleport="body">
        <div
            ...
            class="modal"
        >
            <div x-transition.opacity class="fixed inset-0 bg-black/30 backdrop-blur-sm" @click="showAuthModal = false"></div>
                    ...
                    <div>
                        ...
                        <div class="mb-8" style="max-width: 320px;">
                            <div class="form-group group">
                                ...
                                @error('phoneNumber') <p class="text-error">{{ $message }}</p> @enderror
                            </div>
                        </div>
                        ...
                        <div class="pt-2">
                            ...
                            <div class="flex items-end gap-4" style="display: flex; align-items: flex-end;">
                                <div class="form-group group !mb-0" style="flex: 0 1 320px; max-width: 320px; width: 100%;">
                                    <input
                                        type="text"
                                        placeholder=" "
                                    ...
                                    @error('verificationCode') <p class="text-error">{{ $message }}</p> @enderror
                                </div>
                                ...
                                >
                                    <button
                                        ...
                                        :disabled="timer > 0"
                                        @click="resetTimer()"
                                        class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg px-4 py-2.5 flex items-center gap-2 text-sm transition-colors disabled:opacity-70 whitespace-nowrap"
                                        :class="timer > 0 ? 'cursor-not-allowed text-gray-400 dark:text-gray-400' : 'hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 cursor-pointer'"
                                    >
                        ...
                        <div class="mt-12 flex items-center gap-4">
                            <button
                                type="button"
                                @click="showAuthModal = false; showMethodSelectionModal = true;"
