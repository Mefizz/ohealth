...
лікарських засобів за призначенням з цього плану лікування після цієї дати будуть неможливі!',
    ...
    'referral_accepted_pending' => 'Запит «:document» прийнято в обробку ЕСОЗ. Фінальний статус з’явиться після завершення асинхронної задачі.',
    'referral_signed_success' => ':document успішно створено та підписано в eHealth.',
