...
>
    ...
    <div class="shift-content pl-4 mt-6"
         x-data="{
            activeTab: 'info',
            openDropdown: false,
    ...
    >
        <div class="max-w-screen-xl w-full">
            ...
            <div class="mb-6 flex justify-between items-center">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    <button @click="activeTab = 'info'"
                            ...
                            class="whitespace-nowrap pb-4 px-1 border-b-2 text-sm transition-all cursor-pointer">
                ...
                @if(in_array(strtolower((string)$status), [CarePlanStatus::ACTIVE->value, CarePlanStatus::DRAFT->value, 'new', 'pending']))
                <div class="relative pb-2">
                    ...
                    <div x-show="openDropdown" x-transition style="display: none;" class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-700 border border-gray-100 dark:border-gray-600">
            ...
            <div x-show="activeTab === 'info'">
                    ...
                    <div class="form">
                        <div class="form-row-2">
                            ...
                            <div class="form-group group">
                                ...
                                >
                                <label class="label">
                                    {{ __('care-plan.managing_doctor') ?? 'Керуючий лікар' }}
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset class="fieldset bg-white dark:bg-gray-800 !rounded-xl !shadow-none !border-gray-100 dark:!border-gray-700 !max-w-full !p-6 !mb-6">
                    <legend class="legend">
                        {{ __('care-plan.patient_data') ?? 'Дані пацієнта' }}
                    </legend>
                    ...
                    <div class="form">
                        <div class="form-row-2">
                            ...
                            <div class="form-group group flex items-center">
                                ...
                                <label class="label">
                                    {{ __('care-plan.status_in_ehealth') }}
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="form-group group">
                                <div class="datepicker-wrapper">
                                    ...
                                    <label class="wrapped-label">
                                        {{ __('care-plan.period_start_date') }}
                                    </label>
                                </div>
                            </div>
                        ...
                        <table class="index-table w-full">
                            ...
                            @forelse($carePlan->addresses ?? [] as $address)
                                ...
                                <tr class="index-table-tr">
                                    <td class="index-table-td">{{ $condition?->onset_date?->format('d.m.Y') ?? '-' }}</td>
                                    <td class="index-table-td-primary">{{ $condition ? ($condition->typeConcept?->text ?? $condition->typeConcept?->coding->first()?->display ?? '-') : '-' }}</td>
                                </tr>
                            @empty
                                <tr>
                ...
                <fieldset class="fieldset bg-white dark:bg-gray-800 !rounded-xl !shadow-none !border-gray-100 dark:!border-gray-700 !max-w-full !p-6 !mb-6">
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-gray-700 dark:text-gray-300 text-sm border border-gray-100 dark:border-gray-600 min-h-[90px] whitespace-pre-line">
                ...
                <div class="mt-8 flex items-center gap-4 pt-4 pb-12">
                    ...
                    @elseif($carePlan->uuid && in_array(strtoupper($status), [Status::ACTIVE->value]))
                        <button type="button" class="button-primary-outline" @click="$wire.openSignatureModal('cancel')">
                                ...
                                <tr class="index-table-tr">
                                    <td class="index-table-td">
                                        ...
                                        <div class="text-xs text-gray-400 dark:text-gray-500 mt-1">
                                            ...
                                            @else
                                                ID: <span class="font-mono">{{ $activity->id }} ({{ __('care-plan.status.draft') }})</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="index-table-td">
                                    ...
                                    <td class="index-table-td text-right">
                                        ...
                                        >
                                            <button @click="toggle()"
                                                    ...
                                                    type="button"
                                                    class="record-inner-action-btn cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50 p-2 rounded-lg inline-flex items-center justify-center"
                                            >
