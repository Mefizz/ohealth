...
{
    public function test_reject_keeps_reason_code_and_maps_signed_content(): void
    {
        ...
        Http::assertSent(static function (Request $request): bool {
            ...
            return ($data['reject_reason_code'] ?? null) === 'entered-in-error'
                && ($data['reject_reason'] ?? null) === 'Помилка введення'
                && ($data['signed_medication_reject'] ?? null) === 'mock-signed-blob'
