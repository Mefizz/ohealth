...
>
    <template x-teleport="body">
        <div
            ...
            class="modal"
        >
            <div x-transition.opacity class="fixed inset-0 bg-black/30 backdrop-blur-sm" @click="showMethodSelectionModal = false"></div>
            <div class="modal-wrapper">
                <div
                    @click.stop
                    x-trap.noscroll.inert="showMethodSelectionModal"
                    class="modal-content w-full max-w-4xl mx-auto rounded-2xl p-6 sm:p-8 bg-white dark:bg-gray-800 shadow-xl"
                >
                    <div>
                        ...
                        <template x-if="!authenticationMethods || authenticationMethods.length === 0">
                            <div class="bg-red-100 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl mb-8 p-4">
                                <div class="flex items-center gap-2">
                                    @icon('alert-circle', 'w-5 h-5 text-red-700 dark:text-red-400')
                                    <p class="font-semibold text-red-700 dark:text-red-300">{{ __('forms.patient_has_no_auth_methods') }}</p>
                                </div>
                            </div>
                        </template>
                        ...
                        <template x-if="authenticationMethods && authenticationMethods.length > 0">
                            <div class="space-y-4">
                                <template x-for="(method, methodIndex) in authenticationMethods" :key="methodIndex">
                                    <div class="fieldset border border-gray-200 dark:border-gray-700 p-5 rounded-2xl space-y-3 shadow-none mb-4 bg-white dark:bg-gray-800">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <div x-data="{ open: false }" class="relative">
                                                    <button
                                                        @click="open = !open"
                                                        type="button"
                                                        class="cursor-pointer text-blue-600 hover:underline text-sm font-medium whitespace-nowrap"
                                                    >
                                                        {{ __('patients.change') }}
                                                    </button>
                                                    ...
                                                    <div
                                                        ...
                                                        x-transition
                                                        style="display: none"
                                                        class="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-xl z-50 p-2 border border-gray-100 dark:border-gray-700"
                                                    >
                                                        <template
                                                            ...
                                                            <button
                                                                type="button"
                                                                @click="open = false"
                                                                class="cursor-pointer w-full text-left px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 rounded text-gray-700 dark:text-gray-200"
                                                            >
                                                ...
                                                <button
                                                    type="button"
                                                    class="button-primary whitespace-nowrap px-6 py-2"
                                        ...
                                        <template
                                            ...
                                            <div>
                                                <p class="text-sm text-gray-600 dark:text-gray-300">
                                                    ...
                                                    <span class="text-gray-900 dark:text-white" x-text="method.alias || '-'"></span>
                                                </p>
                                            </div>
                                        </template>
                                        ...
                                        <div class="space-y-2">
                                            <template x-if="method.type === '{{ AuthenticationMethod::OTP->value }}'">
                                                <div class="space-y-1.5 pt-1">
                                                    <label class="label-modal text-xs text-gray-500 dark:text-gray-400 font-medium !mb-1">
                                                    ...
                                                    <template x-if="method.confidantPerson || method.confidant_person">
                                                        <div class="form-row-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    :value="(method.confidantPerson || method.confidant_person)?.name"
                                                                    class="input-modal"
                                                                    readonly
                                                                >
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input
                                                                    :value="(method.confidantPerson || method.confidant_person)?.taxId || (method.confidantPerson || method.confidant_person)?.tax_id"
                                                                    type="text"
                                                                    class="input-modal"
                                                                    readonly
                                                                >
