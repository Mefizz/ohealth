...
<div @class(['breadcrumb-form shift-content p-4' => !$embedded, 'w-full' => $embedded])>
    <div class="mt-6 w-full">
        @php
            ...
            if ($this->encounterIsLocked) {
                unset($wizardSteps[Wizard::STEP_ENCOUNTER]);
            }
        @endphp
        ...
        @if ($step === Wizard::STEP_AUTH_METHOD)
            ...
            <div class="mt-4 flex flex-wrap gap-2">
                ...
                <button
                    type="button"
                    wire:click="goBackFromAuthMethod"
        ...
        @if ($step === Wizard::STEP_DETAILS)
            ...
            <div class="form-row-3 mb-6">
                ...
                <div class="form-group group">
                    ...
                    <label for="form.newbornSex" class="label"> {{ __('compositions.fields.newborn_sex') }} * </label>
            ...
            <div class="flex flex-wrap gap-2">
                <button type="button" wire:click="openCreateSignatureModal" class="button-primary px-5 py-2.5 text-sm">
        ...
        @if ($step === Wizard::STEP_REVIEW)
            ...
            <div class="mt-6 flex flex-wrap gap-2">
                ...
                @if ($embedded)
                    <button type="button" wire:click="requestClose" class="button-primary-outline px-5 py-2.5 text-sm">
                        {{ __('forms.close') }}
                    </button>
                @endif
            </div>
